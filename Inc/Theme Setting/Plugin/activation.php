...
require_once get_template_directory() . '/Inc/Theme Setting/Plugin/theme-tgm-plugin-activation.php';

add_action( 'tgmpa_register', 'vasutheme_register_required_plugins' );

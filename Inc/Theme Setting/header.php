...
function enqueue_custom_colors() {
    ...
    // Get custom colors or set default to black
    $primary_color = get_option('primary_color', '#000000'); // Default to black
    $secondary_color = get_option('secondary_color', '#FFFFFF'); // Default to black
    ...
    // Add inline CSS to the custom-colors stylesheet
    wp_add_inline_style('custom-colors', $custom_css);
}
add_action('wp_enqueue_scripts', 'enqueue_custom_colors');
